            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="user" name="user" placeholder="Please Enter parties">
                 
                </div>

                <div class="form-group">
                   <label for="user">How To:</label>
                 <input type="text" class="form-control" id="hotodo" name="hotodo" placeholder="Task Description">
              ...
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <input type="date" class="form-control" id="start" name="start" placeholder="Enter file name">
                                </div>
                <!-- /.form-group -->
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <select id="rpt" name="rpt"  class="form-control select2" style="">
            ...
            <!-- /.row -->
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <select id="prio" name="prio"  class="form-control select2" style="">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input type="Text" class="form-control" id="comment" name="comment" placeholder="Company's Remarks">
                </div>
