    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li id="visit1"class="nav-item has-treeview visit1t">
            <a href="" class="nav-link">
              <i class="nav-icon fas fa-users"></i>
              <p>
                Visitors
...
<label for="descri"><b>User</b></label>
  ...
  <form action="index2.php" method="POST" class="form-container">
    <p><b>Update your task progress</b></p>
<label for="tid"><b>Task Id</b></label>
...
<script type="text/javascript">
  function hidefunc(){
    ...
    if(perm =="viewAdminDashboard")
    {
      ...
      document.getElementById("visit1").style.display ="block";
