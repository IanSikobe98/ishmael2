          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="../tables/roster.php">View Clients</a></li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="fname" class="form-control" id="parties" placeholder="Please enter the first name of the client">

                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
                      <label>Mobile</label>
                      <input type="number" class="form-control" name="phone" id="bile" placeholder="Enter the mobile number">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="second" id="file" placeholder="please enter the last name of the client">
                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
                      <label>Email Address</label>
                      <input type="Text" class="form-control" id="email" name="email" placeholder="Client's Email address">
                ...
                <div class="row">
                  <div class="col-12 col-sm-6">
                    <div class="form-group">
                      <label>Team Id</label>
                      <input type="number" class="form-control" id="team" name="team" placeholder="Enter Client's Team ID">
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="select2-purple">
                        <input type="password" name="password" class="form-control" id="by" placeholder="Client's Password">
                      </div>
                    </div>
                    <!-- /.form-group -->
                  </div>
...
$url = "http://18.118.17.69:3030/api/auth/v1/local/signUp";
